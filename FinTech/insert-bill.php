				...
				<div class="col-sm-10">
					...
					<form enctype="multipart/form-data" action="insert-bill.php" method="post" name="add_project" id="add_project">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="price" id="price" class="form-control" required maxlength="12" placeholder="$" required pattern="[0-9]{1,3}[,]?[0-9]*[.]?[0-9]*"  title="Enter valid Currency. Onlu numbers, comma and fullstop"  value="<?php if(isset($_POST['price'])) echo $_POST['price'] ?>">
															</div>
						</div>
