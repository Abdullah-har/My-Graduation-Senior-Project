...
if (jQuery("#apex-radialbar-chart").length) {
  options = {
    ...
    colors: ["#37517e", "#fe517e", "#6ce6f4", "#99f6ca"],
  };
  (chart = new ApexCharts(
...
if (jQuery("#apex-pie-chart").length) {
  options = {
    ...
    colors: ["#37517e", "#fe517e", "#6ce6f4", "#99f6ca", "#c8c8c8"],
    responsive: [
      {
        breakpoint: 480,
        options: {
...
if (
  (jQuery("#am-simple-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#37517e")]),
        (e.data = [
          {
            country: "USA",
            visits: 2025,
  ...
  jQuery("#am-barline-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#37517e"), am4core.color("#37517e")]),
        (e.data = [
          {
            year: "2005",
            income: 23.5,
  ...
  jQuery("#am-polar-chart").length &&
    am4core.ready(function () {
      ...
      (a.category = "NW"),
        (a.endCategory = "NW"),
        (a.axisFill.fill = am4core.color("#37517e")),
        (a.axisFill.fillOpacity = 0.3);
      var n = t.axisRanges.create();
      (n.category = "N"),
        (n.endCategory = "N"),
        (n.axisFill.fill = am4core.color("#37517e")),
  ...
  jQuery("#am-layeredcolumn-chart").length &&
    am4core.ready(function () {
      ...
      (e.colors.list = [am4core.color("#99f6ca"), am4core.color("#37517e")]),
  ...
  jQuery("#morris-bar-chart").length &&
    Morris.Bar({
      ...
      ykeys: ["y", "z", "a"],
      labels: ["Y", "Z", "A"],
      barColors: ["#37517e", "#99f6ca", "#99f6ca"],
...
if (jQuery("#home-chart-03").length) {
  options = {
    ...
    colors: ["#37517e", "#6ce6f4", "#a09e9e", "#fbc647"],
    responsive: [
      {
        breakpoint: 480,
        options: {
...
if (jQuery("#sales-unit-chart").length) {
  Highcharts.chart("sales-unit-chart", {
    ...
    colors: ["#37517e", "#fe517e", "#99f6ca", "#ffbf43"],
    series: [
      {
        name: "Brands",
        colorByPoint: true,
...
if (jQuery("#iq-product-chart").length) {
  am4core.ready(function () {
    ...
    chart.colors.list = [am4core.color("#37517e")];
...
if (jQuery("#iq-activety-chart").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-activety-chart"),
    options
  );
  chart.render();
}
if (jQuery("#iq-product-activity").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-product-activity"),
    options
  );
  chart.render();
...
if (jQuery("#iq-income-chart").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-income-chart"),
    options
  );
  chart.render();
}
...
if (jQuery("#iq-chart-profitndloss").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-profitndloss"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-payble").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-payble"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-money").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-money"),
    options
  );
  chart.render();
}
...
if (jQuery("#home-profit-chart").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#home-profit-chart"),
    options
  );
  chart.render();
}
...
if (jQuery("#home-loss-chart").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#home-loss-chart"),
    options
  );
  chart.render();
}
...
if (jQuery("#iq-chart-top").length) {
  am4core.ready(function () {
    ...
    chart.colors.list = [am4core.color("#99f6ca")];
...
if (jQuery("#menu-chart-demo1").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#menu-chart-demo1"),
    options
  );
  chart.render();
}
if (jQuery("#menu-chart-demo2").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#menu-chart-demo2"),
    options
  );
  chart.render();
}
if (jQuery("#menu-chart-demo3").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#menu-chart-demo3"),
    options
  );
  chart.render();
}
if (jQuery("#home-detail-chart").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#home-detail-chart"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-demo1").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-demo1"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-demo2").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-demo2"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-demo3").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-demo3"),
    options
  );
  chart.render();
}
if (jQuery("#iq-chart-demo4").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#iq-chart-demo4"),
    options
  );
  chart.render();
}
if (jQuery("#policy-chart-demo1").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#policy-chart-demo1"),
    options
  );
  chart.render();
}
if (jQuery("#policy-chart-demo2").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#policy-chart-demo2"),
    options
  );
  chart.render();
}
if (jQuery("#review-chart-demo").length) {
  var options = {
    ...
    colors: ["#37517e", "#65f9b3", "#ffbf43", "#fe517e", "#9267ff"],
  ...
  var chart = new ApexCharts(
    document.querySelector("#review-chart-demo"),
    options
  );
  chart.render();
}
...
if (jQuery("#report-chart-02").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#report-chart-02"),
    options
  );
  chart.render();
}
if (jQuery("#report-chart-03").length) {
  ...
  var chart = new ApexCharts(
    document.querySelector("#report-chart-03"),
    options
  );
  chart.render();
}
